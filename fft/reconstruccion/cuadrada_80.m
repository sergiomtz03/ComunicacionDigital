...
amplitudes = data(:,2);  % Columna de amplitudes (se recalcularán)

% Parámetros de la señal
fs = max(frecuencias) * 10; % Frecuencia de muestreo (suficientemente alta)
T = 1 / min(frecuencias);   % Período de la señal fundamental
t = linspace(0, 4 ...
    *T, 1000); % Vector de tiempo para dos períodos

% Constantes del ciclo útil
tau = 0.8 * T; % Ciclo útil del 80%
x = pi * tau / T;

% Calcular amplitudes ajustadas según el ciclo útil del 80%
